...
namespace ShippingQuote
{
    class Program
    {
        static void Main()
        {
            ...
            // If package weighs more than 50 it's too heavy else continue with the dimensions
            if (weight > 50)
            {
            ...
            else
            {
                ...
                // Ternary Operator: If package dimesnion is over 50 it's too be else provide quote
